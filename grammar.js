module.exports = grammar({
    name: "hoon",
    rules: {
        source_file: $ => seq(optional($._gap), $._hoonTall, repeat(seq($._gap, $._hoonTall)), optional($._gap)),
        ...
        _specTall: $ => choice($._bucTall, $._specWide, $.cenhepTall, $.cenlusTall, seq("$;", $._gap, $._specTall),
        ...
        lusbucTall: $ => seq(alias("+$", $.rune), $._gap, $.name, $._gap, $._specTall),
        luslusTall: $ => seq(alias("++", $.rune), $._gap, $.name, $._gap, $._hoonTall),
        lustarTall: $ => seq(alias("+*", $.rune), repeat1(seq($._gap, $.name, $._gap, $._hoonTall))),
        barbucTall: $ => seq(alias("|$", $.rune), $._gap, choice($.name, seq("[", $.name, repeat(seq($._gap, $.name)), "]")), $._gap, $._specTall),
        barcabTall: $ => seq(alias("|_", $.rune), $._gap, $._specTall, $._gap, choice($._lusTall, $.lustarTall), repeat(seq($._gap, $._lusTall)), $._gap, $.coreTerminator),
        barcolTall: $ => seq(alias("|:", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        barcenTall: $ => seq(alias("|%", $.rune), $._gap, $._lusTall, repeat(seq($._gap, $._lusTall)), $._gap, $.coreTerminator),
        bardotTall: $ => seq(alias("|.", $.rune), $._gap, $._hoonTall),
        barketTall: $ => seq(alias("|^", $.rune), $._gap, $._hoonTall, $._gap, $._lusTall, repeat(seq($._gap, $._lusTall)), $._gap, $.coreTerminator),
        barhepTall: $ => seq(alias("|-", $.rune), $._gap, $._hoonTall),
        barsigTall: $ => seq(alias("|~", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        bartarTall: $ => seq(alias("|*", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        bartisTall: $ => seq(alias("|=", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        barpatTall: $ => seq(alias("|@", $.rune), $._gap, $._lusTall, repeat(seq($._gap, $._lusTall)), $._gap, $.coreTerminator),
        barwutTall: $ => seq(alias("|?", $.rune), $._gap, $._hoonTall),
        bucbarTall: $ => seq(alias("$|", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        buccabTall: $ => seq(alias("$_", $.rune), $._gap, $._hoonTall),
        buccenTall: $ => seq(alias("$%", $.rune), $._gap, repeat1(seq($._specTall, $._gap)), $.seriesTerminator),
        buccolTall: $ => seq(alias(seq("$", ":"), $.rune), $._gap, repeat1(seq($._specTall, $._gap)), $.seriesTerminator),
        bucgalTall: $ => seq(alias("$<", $.rune), $._gap, $._specTall, $._gap, $._specTall),
        bucgarTall: $ => seq(alias("$>", $.rune), $._gap, $._specTall, $._gap, $._specTall),
        buchepTall: $ => seq(alias("$-", $.rune), $._gap, $._specTall, $._gap, $._specTall),
        bucketTall: $ => seq(alias("$^", $.rune), $._gap, $._specTall, $._gap, $._specTall),
        buclusTall: $ => seq(alias(seq("$", "+"), $.rune), $._gap, $._studTall, $._gap, $._specTall),
        bucpamTall: $ => seq(alias("$&", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        bucsigTall: $ => seq(alias("$~", $.rune), $._gap, $._hoonTall, $._gap, $._specTall),
        bucpatTall: $ => seq(alias("$@", $.rune), $._gap, $._specTall, $._gap, $._specTall),
        buctisTall: $ => seq(alias("$=", $.rune), $._gap, $._skinTall, $._gap, $._specTall),
        bucwutTall: $ => seq(alias("$?", $.rune), $._gap, repeat1(seq($._specTall, $._gap)), $.seriesTerminator),
        cencabTall: $ => seq(alias("%_", $.rune), $._gap, $._wingTall, $._gap, repeat1(seq($._wingTall, $._gap, $._hoonTall, $._gap)), $.seriesTerminator),
        cencolTall: $ => seq(alias("%:", $.rune), $._gap, $._hoonTall, $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        cendotTall: $ => seq(alias(seq("%", "."), $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        cenhepTall: $ => seq(alias("%-", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        cenketTall: $ => seq(alias("%^", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        cenlusTall: $ => seq(alias("%+", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        censigTall: $ => seq(alias(seq("%", "~"), $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        centarTall: $ => seq(alias("%*", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, repeat1(seq($._wingTall, $._gap, $._hoonTall, $._gap)), $.seriesTerminator),
        centisTall: $ => seq(alias("%=", $.rune), $._gap, $._wingTall, $._gap, repeat1(seq($._wingTall, $._gap, $._hoonTall, $._gap)), $.seriesTerminator),
        colhepTall: $ => seq(alias(":-", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        colcabTall: $ => seq(alias(":_", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        collusTall: $ => seq(alias(":+", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        colketTall: $ => seq(alias(":^", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        coltarTall: $ => seq(alias(":*", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        colsigTall: $ => seq(alias(":~", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        dotketTall: $ => seq(alias(".^", $.rune), $._gap, $._specTall, $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        dotlusTall: $ => seq(alias(".+", $.rune), $._gap, $._hoonTall),
        dottarTall: $ => seq(alias(".*", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        dottisTall: $ => seq(alias(".=", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        dotwutTall: $ => seq(alias(".?", $.rune), $._gap, $._hoonTall),
        faslusTall: $ => seq(alias("/+", $.rune), $._gap, optional("*"), $.name, optional(seq("=", $.name)), repeat(seq(",", choice($._gap, $._space), optional("*"), $.name, optional(seq("=", $.name))))),
        fashepTall: $ => seq(alias("/-", $.rune), $._gap, optional("*"), $.name, optional(seq("=", $.name)), repeat(seq(",", choice($._gap, $._space), optional("*"), $.name, optional(seq("=", $.name))))),
        fastisTall: $ => seq(alias("/=", $.rune), $._gap, $.name, $._gap, $.path),
        fastarTall: $ => seq(alias("/*", $.rune), $._gap, $.name, $._gap, $.term, $._gap, $.path),
        fasbucTall: $ => seq(alias("/$", $.rune), $._gap, $.name, $._gap, $.term, $._gap, $.term),
        fassigTall: $ => seq(alias("/~", $.rune), $._gap, $.name, $._gap, $._specWide, $._gap, $.path),
        ...
        ketdotTall: $ => seq(alias("^.", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        kethepTall: $ => seq(alias("^-", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        ketlusTall: $ => seq(alias("^+", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        ketpamTall: $ => seq(alias("^&", $.rune), $._gap, $._hoonTall),
        ketsigTall: $ => seq(alias("^~", $.rune), $._gap, $._hoonTall),
        kettarTall: $ => seq(alias("^*", $.rune), $._gap, $._specTall),
        kettisTall: $ => seq(alias("^=", $.rune), $._gap, $._skinTall, $._gap, $._hoonTall),
        ketwutTall: $ => seq(alias("^?", $.rune), $._gap, $._hoonTall),
        miccolTall: $ => seq(alias(";:", $.rune), $._gap, $._hoonTall, $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        micgalTall: $ => seq(alias(";<", $.rune), $._gap, $._specTall, $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        miclusTall: $ => seq(alias(";+", $.rune), $._gap, $._hoonTall),
        micmicTall: $ => seq(alias(";;", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        micfasTall: $ => seq(alias(";/", $.rune), $._gap, $._hoonTall),
        micsigTall: $ => seq(alias(";~", $.rune), $._gap, $._hoonTall, $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        mictarTall: $ => seq(alias(";*", $.rune), $._gap, $._hoonTall),
        mictisTall: $ => seq(alias(";=", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        siggarTall: $ => seq(alias("~>", $.rune), $._gap, $._termWide, optional(seq(".", optional($._gap), $._hoonTall)), $._gap, $._hoonTall),
        sigbarTall: $ => seq(alias("~|", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        sigbucTall: $ => seq(alias("~$", $.rune), $._gap, $._termTall, $._gap, $._hoonTall),
        sigcabTall: $ => seq(alias("~_", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        sigcenTall: $ => seq(alias("~%", $.rune), $._gap, $._chumTall, $._gap, $._hoonTall, $._gap, choice("~", seq($.seriesTerminator, $._gap, repeat1(seq($._hoonWide, $._gap, $._hoonTall, $._gap)), $.seriesTerminator)), $._gap, $._hoonTall),
        siggalTall: $ => seq(alias("~<", $.rune), $._gap, $._termWide, optional(seq(".", optional($._gap), $._hoonTall)), $._gap, $._hoonTall),
        siglusTall: $ => seq(alias("~+", $.rune), $._gap, $._hoonTall),
        sigfasTall: $ => seq(alias("~/", $.rune), $._gap, $._chumTall, $._gap, $._hoonTall),
        sigpamTall: $ => seq(alias("~&", $.rune), $._gap, optional(seq(choice(">", ">>", ">>>"), $._gap)), $._hoonTall, $._gap, $._hoonTall),
        sigtisTall: $ => seq(alias("~=", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        sigwutTall: $ => seq(alias("~?", $.rune), $._gap, optional(seq(choice(">", ">>", ">>>"), $._gap)), $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        sigzapTall: $ => seq(alias("~!", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        tisgarTall: $ => seq(alias("=>", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        tisbarTall: $ => seq(alias("=|", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        tiscolTall: $ => seq(alias("=:", $.rune), $._gap, repeat1(seq($._wingTall, $._gap, $._hoonTall, $._gap)), $.seriesTerminator, $._gap, $._hoonTall),
        tiscomTall: $ => seq(alias("=,", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        tisdotTall: $ => seq(alias("=.", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        tishepTall: $ => seq(alias("=-", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        tisketTall: $ => seq(alias("=^", $.rune), $._gap, $._skinTall, $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        tisgalTall: $ => seq(alias("=<", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        tislusTall: $ => seq(alias("=+", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        tismicTall: $ => seq(alias("=;", $.rune), $._gap, $._skinTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        tisfasTall: $ => seq(alias("=/", $.rune), $._gap, field("name", $._skinTall), $._gap, $._hoonTall, $._gap, $._hoonTall),
        tissigTall: $ => seq(alias("=~", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        tistarTall: $ => seq(alias("=*", $.rune), $._gap, choice($._termTall, seq($.name, "=", $._specWide)), $._gap, $._hoonTall, $._gap, $._hoonTall),
        tiswutTall: $ => seq(alias("=?", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        wutbarTall: $ => seq(alias("?|", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        wuthepTall: $ => seq(alias("?-", $.rune), $._gap, $._wingTall, $._gap, repeat1(seq($._specTall, $._gap, $._valueTall, $._gap)), $.seriesTerminator),
        wutcolTall: $ => seq(alias(seq("?", ":"), $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        wutdotTall: $ => seq(alias("?.", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        wutketTall: $ => seq(alias("?^", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        wutgalTall: $ => seq(alias("?<", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        wutgarTall: $ => seq(alias("?>", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        wutlusTall: $ => seq(alias("?+", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, repeat1(seq($._specTall, $._gap, $._hoonTall, $._gap)), $.seriesTerminator),
        wutpamTall: $ => seq(alias("?&", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), $.seriesTerminator),
        wutpatTall: $ => seq(alias("?@", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        wutsigTall: $ => seq(alias("?~", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        wuttisTall: $ => seq(alias("?=", $.rune), $._gap, $._specTall, $._gap, $._wingTall),
        wutzapTall: $ => seq(alias("?!", $.rune), $._gap, $._hoonTall),
        zapcomTall: $ => seq(alias("!,", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        zapgarTall: $ => seq(alias("!>", $.rune), $._gap, $._hoonTall),
        zapgalTall: $ => seq(alias("!<", $.rune), $._gap, $._specTall, $._gap, $._hoonTall),
        zapmicTall: $ => seq(alias("!;", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        zaptisTall: $ => prec(1, seq(alias(seq("!", "="), $.rune), $._gap, $._hoonTall)),
        zapwutTall: $ => prec(1, seq(alias(seq("!", "?"), $.rune), $._gap, choice($.number, seq("[", $.number, $._space, $.number, "]")), $._gap, $._hoonTall)),
        zappatTall: $ => seq(alias("!@", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, $._hoonTall),
        ...
        siggarWide: $ => seq(alias("~>", $.rune), "(", $._termWide, optional(seq(".", optional($._gap), $._hoonWide)), $._space, $._hoonWide, ")"),
        ...
        siggalWide: $ => seq(alias("~<", $.rune), "(", $._termWide, optional(seq(".", optional($._gap), $._hoonWide)), $._space, $._hoonWide, ")"),
        ...
        number: $ => prec.right(0, choice(
            seq(optional(choice("--", "-")), choice(
                ...
                seq(/0x[0-9a-fA-F]{1,4}/, repeat(seq(".", optional($._gap), /[0-9a-fA-F]{4}/))), //@ux
                seq(/0b[01]{1,4}/, repeat(seq(".", optional($._gap), /[01]{4}/))), //@ub
                /0i[0-9]+/, //@ui
                seq(/0v[0-9a-v]{1,5}/, repeat(seq(".", optional($._gap), /[0-9a-v]{5}/))), //@uv
                seq(/0w[0-9a-zA-Z-~]{1,5}/, repeat(seq(".", optional($._gap), /[0-9a-zA-Z-~]{5}/))) //@uw
            )
        ...
        lark: $ => choice("+", "-", /(([-+][<>])+)|([-+]([<>][-+])+)/),
        //strings
        tape: $ => choice(seq('"', /([^\n{"\\]|\\\\|\\\"|\\\{|\\\w\w)*/, repeat(seq("{", $._hoonWide, "}", /([^\n{"\\]|\\\\|\\\"|\\\{|\\\w\w)*/,)), '"',
            repeat(seq(".", optional($._gap), '"', /([^\n{"\\]|\\\\|\\\"|\\\{|\\\w\w)*/, repeat(seq("{", $._hoonWide, "}", /([^\n{"\\]|\\\\|\\\"|\\\{|\\\w\w)*/,)), '"'))),
            // seq('"""\n', repeat(seq(/[^{]*/, "{", $._hoonWide, "}")), /.*/, '\n"""')), 
            /\"\"\"\n(.|\n)+?\n\"\"\"/),
        cord: $ => choice(seq("'", /([^\n'\\]|\\\\|\\\'|\\\w{2,})*/, repeat(seq("\\", optional($._gap), "/", /([^\n'\\]|\\\\|\\\'|\\\w{2,})+/)), "'"), /\'\'\'\n(.|\n)+\n\'\'\'/),
        knot: $ => seq("~.", /[0-9a-zA-Z~_.-]*/),
        string: $ => choice($.tape, $.cord, $.knot),
        date: $ => seq(choice(
        ...
        path: $ => seq(optional("%"), choice("/", repeat1(seq(repeat1("/"), choice($.name, $.cell, $.gateCall, $.number, $.cord, $.knot, $.date))))),
        seriesTerminator: $ => "==",
        coreTerminator: $ => "--",
    },
    extras: $ => [$._lineComment],
