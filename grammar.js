module.exports = grammar({
    ...
    rules: {
        ...
        _specWide: $ => choice(
            ...
            prec.left(0, seq(optional($._specWide), "=", $._specWide)),// $.wrapFace,
            $.mold,
        ...
        barcabTall: $ => seq(alias("|_", $.rune), $._gap, $._specTall, $._gap, choice($._lusTall, $.lustarTall), repeat(seq($._gap, $._lusTall)), $._gap, "--"),
        barcolTall: $ => seq(alias("|:", $.rune), $._gap, $._hoonTall, $._gap, $._hoonTall),
        barcenTall: $ => seq(alias("|%", $.rune), $._gap, $._lusTall, repeat(seq($._gap, $._lusTall)), $._gap, "--"),
        bardotTall: $ => seq(alias("|.", $.rune), $._gap, $._hoonTall),
        barketTall: $ => seq(alias("|^", $.rune), $._gap, $._hoonTall, $._gap, $._lusTall, repeat(seq($._gap, $._lusTall)), $._gap, "--"),
        ...
        barpatTall: $ => seq(alias("|@", $.rune), $._gap, $._lusTall, repeat(seq($._gap, $._lusTall)), $._gap, "--"),
        ...
        buccenTall: $ => seq(alias("$%", $.rune), $._gap, repeat1(seq($._specTall, $._gap)), "=="),
        buccolTall: $ => seq(alias(seq("$", ":"), $.rune), $._gap, repeat1(seq($._specTall, $._gap)), "=="),
        ...
        bucwutTall: $ => seq(alias("$?", $.rune), $._gap, repeat1(seq($._specTall, $._gap)), "=="),
        cencabTall: $ => seq(alias("%_", $.rune), $._gap, $._wingTall, $._gap, repeat1(seq($._wingTall, $._gap, $._hoonTall, $._gap)), "=="),
        cencolTall: $ => seq(alias("%:", $.rune), $._gap, $._hoonTall, $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        ...
        centarTall: $ => seq(alias("%*", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, repeat1(seq($._wingTall, $._gap, $._hoonTall, $._gap)), "=="),
        centisTall: $ => seq(alias("%=", $.rune), $._gap, $._wingTall, $._gap, repeat1(seq($._wingTall, $._gap, $._hoonTall, $._gap)), "=="),
        ...
        coltarTall: $ => seq(alias(":*", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        colsigTall: $ => seq(alias(":~", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        dotketTall: $ => seq(alias(".^", $.rune), $._gap, $._specTall, $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        ...
        miccolTall: $ => seq(alias(";:", $.rune), $._gap, $._hoonTall, $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        ...
        micsigTall: $ => seq(alias(";~", $.rune), $._gap, $._hoonTall, $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        mictarTall: $ => seq(alias(";*", $.rune), $._gap, $._hoonTall),
        mictisTall: $ => seq(alias(";=", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        ...
        sigcenTall: $ => seq(alias("~%", $.rune), $._gap, $._chumTall, $._gap, $._hoonTall, $._gap, choice("~", seq("==", $._gap, repeat1(seq($._hoonWide, $._gap, $._hoonTall, $._gap)), "==")), $._gap, $._hoonTall),
        ...
        tiscolTall: $ => seq(alias("=:", $.rune), $._gap, repeat1(seq($._wingTall, $._gap, $._hoonTall, $._gap)), "==", $._gap, $._hoonTall),
        ...
        tissigTall: $ => seq(alias("=~", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        ...
        wutbarTall: $ => seq(alias("?|", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
        wuthepTall: $ => seq(alias("?-", $.rune), $._gap, $._wingTall, $._gap, repeat1(seq($._specTall, $._gap, $._valueTall, $._gap)), "=="),
        ...
        wutlusTall: $ => seq(alias("?+", $.rune), $._gap, $._wingTall, $._gap, $._hoonTall, $._gap, repeat1(seq($._specTall, $._gap, $._hoonTall, $._gap)), "=="),
        wutpamTall: $ => seq(alias("?&", $.rune), $._gap, repeat1(seq($._hoonTall, $._gap)), "=="),
